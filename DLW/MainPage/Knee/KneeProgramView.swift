        ...
        VStack {
            ZStack(alignment: .top) {
                ...
                VStack(spacing: 0) {
                    ...
                    KneeListView(movesChosen: $model.data, searchString: $searchString)
    ...
    struct DragRelocateView: View {
        ...
        var body: some View {
            VStack {
                ...
                NavigationLink(destination: KneeConfirmView(movesChosen: $model.data)) {
