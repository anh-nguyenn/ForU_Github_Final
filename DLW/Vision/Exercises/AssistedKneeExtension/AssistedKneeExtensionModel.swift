...
class AssistedKneeExtensionModel: Move {
    
    /// Singleton instance of `AssistedKneeExtensionModel`.
    static var shared: AssistedKneeExtensionModel = AssistedKneeExtensionModel()
    
    /// The array of timers for the instance of `AssistedKneeExtensionModel`.
    ...
    @Published var currentStateDescription: String = AssistedKneeExtensionModel.InitialState().description
    ...
    init() {
        ...
        super.init(
            states: states,
            thisId: 11,
            thisName: "Assisted Knee Extension",
            thisType: 1,
            thisImage: gifImages,
            totalSets: AssistedKneeExtensionModel.sets,
            totalRepetitions: (AssistedKneeExtensionModel.repetitions * AssistedKneeExtensionModel.sets),
            bufferInterval: 10,
            setCompletedInterval: 10
        )
        timerLoop()
        self.enter(AssistedKneeExtensionModel.InitialState.self)
    }
    
    /// Function to reset the state machine back to the initial state.
    override func resetStateMachine() {
        AssistedKneeExtensionModel.resetSharedStateMachine()
    }
    
    /// Getter function to get the singleton instance variable of the model.
    override func getShared() -> Move {
        return AssistedKneeExtensionModel.shared
    }
    
    /// Resets the singleton instance of the model.
    private static func resetSharedStateMachine() {
        shared = AssistedKneeExtensionModel()
    }
    ...
    class InitialState: GKState {
        ...
        override var description: String {
            get {
                return "AssistedKneeExtensionInitial"
            }
        }
    }
    ...
    class CalibrationState: GKState {
        ...
        override func didEnter(from: GKState?) {
            AssistedKneeExtensionModel.invalidateAllTimers()
            AudioManager.speakText(text: "While seated, ensure that your entire injured leg can be seen in the frame.")
            AssistedKneeExtensionModel.shared.audioLastPlayedTime = Date.now
        }
        /// Description of the calibration state.
        override var description: String {
            get {
                return "AssistedKneeExtensionCalibration"
            }
        }
    }
    ...
    class StartState: GKState {
        ...
        override func didEnter(from: GKState?) {
            let assistedKneeExtensionModel = AssistedKneeExtensionModel.shared
            let text: String
            ...
            assistedKneeExtensionModel.audioLastPlayedTime = Date.now
        }
        /// Description of the start state.
        override var description: String {
            get {
                return "AssistedKneeExtensionStart"
            }
        }
    }
    ...
    class InPositionState: GKState {
        ...
        override var description: String {
            get {
                return "AssistedKneeExtensionInPosition"
            }
        }
    }
    ...
    class RepetitionState: GKState {
        ...
        override var description: String {
            get {
                return "AssistedKneeExtensionRepetition"
            }
        }
    }
    ...
    class RepetitionInitialState: GKState {
        ...
        override var description: String {
            get {
                return "AssistedKneeExtensionRepetitionInitial"
            }
        }
    }
    ...
    class RepetitionInProgressState: GKState {
        ...
        override var description: String {
            get {
                return "AssistedKneeExtensionInProgress"
            }
        }
    }
    ...
    class RepetitionCompletedState: GKState {
        ...
        override func didEnter(from: GKState?) {
            ...
            let playAudio = -AssistedKneeExtensionModel.shared.notificationTime.timeIntervalSinceNow > notificationInterval
        ...
        override var description: String {
            get {
                return "AssistedKneeExtensionCompleted"
            }
        }
    }
    ...
    class ExerciseEndState: GKState {
        ...
        override var description: String {
            get {
                return "AssistedKneeExtensionEnd"
            }
        }
    }
}
