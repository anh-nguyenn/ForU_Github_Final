...
struct ShoulderExtensionInPositionClassifier: Classifier {
    static func check(observation: VNHumanBodyPoseObservation) -> Bool {
        ...
        // Check if arm was raised to shoulder height
        if armToHipAngle < 80 || armToHipAngle > 95  {
            return false
        }
        
        // Capture the last exact angle
        if shoulderExtensionModel.calibrationFrames > 20 {
