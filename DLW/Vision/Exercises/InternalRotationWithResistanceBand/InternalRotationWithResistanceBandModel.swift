...
/// The model for Internal Rotation with Resistance Band exercise.
class InternalRotationWithResistanceBandModel: Move {
    
    /// Singleton instance of `InternalRotationWithResistanceBandModel`.
    static var shared: InternalRotationWithResistanceBandModel = InternalRotationWithResistanceBandModel()
    
    /// The array of timers for the instance of `InternalRotationWithResistanceBandModel`.
    ...
    @Published var currentStateDescription: String = InternalRotationWithResistanceBandModel.InitialState().description
    ...
    init() {
        ...
        super.init(
            states: states,
            thisId: 5,
            thisName: "Internal Rotation with Resistance Band",
            thisType: 1,
            thisImage: gifImages,
            totalSets: InternalRotationWithResistanceBandModel.sets,
            totalRepetitions: (InternalRotationWithResistanceBandModel.repetitions * InternalRotationWithResistanceBandModel.sets),
            bufferInterval: 10,
            setCompletedInterval: 10
        )
        timerLoop()
        self.enter(InternalRotationWithResistanceBandModel.InitialState.self)
    }
    
    /// Function to reset the state machine back to the initial state.
    override func resetStateMachine() {
        InternalRotationWithResistanceBandModel.resetSharedStateMachine()
    }
    
    /// Getter function to get the singleton instance variable of the model.
    override func getShared() -> Move {
        return InternalRotationWithResistanceBandModel.shared
    }
    
    /// Resets the singleton instance of the model.
    private static func resetSharedStateMachine() {
        shared = InternalRotationWithResistanceBandModel()
    }
    ...
    class InitialState: GKState {
        ...
        override var description: String {
            get {
                return "InternalRotationWithResistanceBandInitial"
            }
        }
    }
    ...
    class CalibrationState: GKState {
        ...
        override func didEnter(from: GKState?) {
            InternalRotationWithResistanceBandModel.invalidateAllTimers()
            ...
            InternalRotationWithResistanceBandModel.shared.audioLastPlayedTime = Date.now
        }
        /// Description of the calibration state.
        override var description: String {
            get {
                return "InternalRotationWithResistanceBandCalibration"
            }
        }
    }
    ...
    class StartState: GKState {
        ...
        override func didEnter(from: GKState?) {
            let internalRotationWithResistanceBandModel = InternalRotationWithResistanceBandModel.shared
            let text: String
            ...
            internalRotationWithResistanceBandModel.audioLastPlayedTime = Date.now
        }
        /// Description of the start state.
        override var description: String {
            get {
                return "InternalRotationWithResistanceBandStart"
            }
        }
    }
    ...
    class InPositionState: GKState {
        ...
        override var description: String {
            get {
                return "InternalRotationWithResistanceBandInPosition"
            }
        }
    }
    ...
    class RepetitionState: GKState {
        ...
        override var description: String {
            get {
                return "InternalRotationWithResistanceBandRepetition"
            }
        }
    }
    ...
    class RepetitionInitialState: GKState {
        ...
        override func didEnter(from: GKState?) {
            AudioManager.speakText(text: "Slowly rotate your arm inwards.")
            InternalRotationWithResistanceBandModel.shared.audioLastPlayedTime = Date.now
        }
        /// Description of the repetitionInitial state.
        override var description: String {
            get {
                return "InternalRotationWithResistanceBandRepetitionInitial"
            }
        }
    }
    ...
    class RepetitionInProgressState: GKState {
        ...
        override func didEnter(from: GKState?) {
            AudioManager.speakText(text: "Try to rotate your arm inwards as much as possible.")
            InternalRotationWithResistanceBandModel.shared.audioLastPlayedTime = Date.now
        }
        /// Description of the repetitionInProgress state.
        override var description: String {
            get {
                return "InternalRotationWithResistanceBandInProgress"
            }
        }
    }
    ...
    class RepetitionCompletedState: GKState {
        ...
        override func didEnter(from: GKState?) {
            ...
            let playAudio = -InternalRotationWithResistanceBandModel.shared.notificationTime.timeIntervalSinceNow > notificationInterval
        ...
        override var description: String {
            get {
                return "InternalRotationWithResistanceBandCompleted"
            }
        }
    }
    ...
    class ExerciseEndState: GKState {
        ...
        override var description: String {
            get {
                return "InternalRotationWithResistanceBandEnd"
            }
        }
    }
}
